...
<a href="#0">HTTP 支持的方法</a>
<a href="#1">HTTP 方法的幂等和安全性</a>
<a href="#2">HTTP 状态码</a>
&emsp;<a href="#3"> ## 1XX 信息</a>
&emsp;<a href="#4"> ## 2XX 成功</a>
&emsp;<a href="#5"> ## 3XX 重定向</a>
&emsp;<a href="#6"> ## 4XX 客户端错误</a>
&emsp;<a href="#7"> ## 5XX 服务器错误</a>
<a href="#8">HTTP 报文结构</a>
<a href="#9">HTTP 并行连接、持久连接、管道化连接</a>
<a href="#10">HTTP/1.0 与 HTTP/1.1 的区别</a>
<a href="#11">HTTP/1.0 与 HTTP/1.1 的区别</a>
<a href="#12">HTTP/1.1 与 HTTP/2.0 的区别</a>
<a href="#13">HTTP/2.0 vs SPDY</a>
<a href="#14">HTTP/3</a>
<a href="#15">HTTPS 流程</a>
<a href="#16">DNS 递归查询和递归查询</a>
<a href="#17">HTTP 劫持</a>
<a href="#18">DNS 劫持</a>
<a href="#19">HTTP 劫持和 DNS 劫持区别</a>
<a href="#20">DNS 污染</a>
<a href="#21">DNS 常见的记录类型</a>
<a href="#22">HTTP DNS</a>
<a href="#23">DNS 基于 UDP 还是 TCP</a>
<a href="#24">TCP 怎么保证可靠传输？</a>
<a href="#25">TCP 怎么保证数据顺序不变和非重复</a>
<a href="#26">TCP 滑动窗口</a>
<a href="#27">TCP 流量控制</a>
<a href="#28">TCP 拥塞控制</a>
<a href="#29">拥塞控制和流量控制的区别</a>
<a href="#30">TCP 三次握手</a>
<a href="#31">为什么是三次握手</a>
<a href="#32">SYN攻击:</a>
<a href="#33">      # netstat -na TCP | grep SYN_RECV | more，</a>
<a href="#34">TCP 四次挥手</a>
<a href="#35">TCP 为什么要进行四次挥手？ / 为什么 TCP 建立连接需要三次，而释放连接则需要四次？</a>
<a href="#36">为什么 TCP 连接时可以 ACK 和 SYN 一起发送，而释放时则 ACK 和 FIN 分开发送呢？（ACK 和 FIN 分开是指第二次和第三次挥手）</a>
<a href="#37">为什么客户端释放最后需要 TIME-WAIT 等待 2MSL 呢？</a>
<a href="#38">CLOSE_WAIT 过多的解决方法</a>
<a href="#39">TCP keepalive</a>
<a href="#40">TCP keepalive 和 HTTP 中 Keep-Alive 的关系</a>
<a href="#41">TIME_WAIT 过多的解决方法</a>
<a href="#42">TCP 三次握手中第三次可以传递数据吗？</a>
<a href="#43">TCP 半连接队列和全连接队列</a>
<a href="#44">Socket 的交互流程</a>
<a href="#45">怎么强行断开 TCP 连接</a>
<a href="#46">TCP 粘包</a>
<a href="#47">TCP 协议的延迟应答，捎带应答，累计应答</a>
<a href="#48">TCP 可不可以绕过三次握手?</a>
<a href="#49">TCP 和 UDP 的适用场景</a>
<a href="#50">Linux TCP/IP 内核参数</a>
<a href="#51">IPv6 和 IPv4 区别</a>
<a href="#52">ICMP (Internet Control Message Protocol)</a>
<a href="#53">ARP (Address Resolution Protocol)</a>
...
| 5XX | Server Error（服务器错误状态码） | 服务器处理请求出错 |
    ...
    ## <a name="3">1XX 信息</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    -  **100 Continue** ：表明到目前为止都很正常，客户端可以继续发送请求或者忽略这个响应。

    ## <a name="4">2XX 成功</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
    ...
    ## <a name="5">3XX 重定向</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
    ...
    ## <a name="6">4XX 客户端错误</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
    ...
    ## <a name="7">5XX 服务器错误</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    -  **500 Internal Server Error** ：服务器正在执行请求时发生错误。
    -  **503 Service Unavilable** ：服务器暂时处于超负载或正在进行停机维护，现在无法处理请求。

# <a name="8">HTTP 报文结构</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="9">HTTP 并行连接、持久连接、管道化连接</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="10">HTTP/1.0 与 HTTP/1.1 的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="11">HTTP/1.0 与 HTTP/1.1 的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="12">HTTP/1.1 与 HTTP/2.0 的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="13">HTTP/2.0 vs SPDY</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="14">HTTP/3</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="15">HTTPS 流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="16">DNS 递归查询和递归查询</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="17">HTTP 劫持</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="18">DNS 劫持</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="19">HTTP 劫持和 DNS 劫持区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="20">DNS 污染</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="21">DNS 常见的记录类型</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="22">HTTP DNS</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    当客户端需要 DNS 解析的时候，直接通过 HTTP 协议请求服务器，获得 IP 地址，绕过传统的 DNS 解析的过程。

# <a name="23">DNS 基于 UDP 还是 TCP</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="24">TCP 怎么保证可靠传输？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    TCP 使用校验和（主要用于防止数据丢失，保证完整性，不能防止篡改），确认和重传机制来。

# <a name="25">TCP 怎么保证数据顺序不变和非重复</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    TCP 给数据分节进行排序，并使用累积确认保证数据的顺序不变和非重复。

# <a name="26">TCP 滑动窗口</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="27">TCP 流量控制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="28">TCP 拥塞控制</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="29">拥塞控制和流量控制的区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    拥塞控制：拥塞控制是作用于网络的，它是防止过多的数据注入到网络中，避免出现网络负载过大的情况。
              常用的方法就是：（1）慢开始、拥塞避免（2）快重传、快恢复。
    流量控制：流量控制是作用于接收者的，它是控制发送者的发送速度从而使接收者来得及接收，防止分组丢失的。

# <a name="30">TCP 三次握手</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="31">为什么是三次握手</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="32">SYN攻击:</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
    ...
    2. 如何检测 SYN 攻击？
       ...
       在 Linux/Unix 上可以使用系统自带的 netstats 命令来检测 SYN 攻击。
        ...
        ```http
        # <a name="33">netstat -na TCP | grep SYN_RECV | more，</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
        ```
...
# <a name="34">TCP 四次挥手</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="35">TCP 为什么要进行四次挥手？ / 为什么 TCP 建立连接需要三次，而释放连接则需要四次？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="36">为什么 TCP 连接时可以 ACK 和 SYN 一起发送，而释放时则 ACK 和 FIN 分开发送呢？（ACK 和 FIN 分开是指第二次和第三次挥手）</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="37">为什么客户端释放最后需要 TIME-WAIT 等待 2MSL 呢？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="38">CLOSE_WAIT 过多的解决方法</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="39">TCP keepalive</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="40">TCP keepalive 和 HTTP 中 Keep-Alive 的关系</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    1. HTTP 协议的 Keep-Alive 意图在于连接复用，同一个连接上串行方式传递请求-响应数据
    2. TCP 的 KeepAlive 机制意图在于保活、心跳，检测连接错误

# <a name="41">TIME_WAIT 过多的解决方法</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="42">TCP 三次握手中第三次可以传递数据吗？</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    可以

# <a name="43">TCP 半连接队列和全连接队列</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="44">Socket 的交互流程</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="45">怎么强行断开 TCP 连接</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="46">TCP 粘包</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="47">TCP 协议的延迟应答，捎带应答，累计应答</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="48">TCP 可不可以绕过三次握手?</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="49">TCP 和 UDP 的适用场景</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="50">Linux TCP/IP 内核参数</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="51">IPv6 和 IPv4 区别</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="52">ICMP (Internet Control Message Protocol)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

    ICMP 协议（和 IP 协议同处网络层）主要用来检测网络通信故障和实现链路追踪，最典型的应用就是 PING 和 tracerooute。
    在 IPv6 中，ICMP 的作用被扩大，如果没有 ICMPv6，IPv6 就无法进行正常的通信。

# <a name="53">ARP (Address Resolution Protocol)</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
